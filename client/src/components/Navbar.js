...
const Navbar = () => {
  ...
  // Reset the values in our state store, which persist in our local storage
  // This is basically clearing our local storage
        ...
        {user
          ...
          <div>
            <div className="dropdown dropdown-end">
              <h3
                tabIndex={0}
                className="font-black text-sm hover:underline underline-offset-8 decoration-blue-600 tracking-widest -translate-y-1"
              >
                ACCOUNT
              </h3>
              <ul
